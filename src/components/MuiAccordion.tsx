...
<Accordion expanded={expanded === 'panel1'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel1') }>
        ...
        <AccordionDetails>
   <Typography>
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Porro sunt adipisci at nam temporibus recusandae? Perspiciatis deleniti nam hic rem.
   </Typography>
        </AccordionDetails>
    </Accordion>
    ...
    <Accordion expanded={expanded === 'panel2'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel2') }>
        <AccordionSummary id='pane2-header' aria-controls='panel2-content' expandIcon={<ExpandMoreIcon></ExpandMoreIcon>}>
   ...
   <Typography>
    ...
    <Accordion expanded={expanded === 'panel3'} onChange={(event, isExpanded) => handleChange(isExpanded, 'panel3') }>
        <AccordionSummary id='panel3-header' aria-controls='panel3-content' expandIcon={<ExpandMoreIcon></ExpandMoreIcon>}>
